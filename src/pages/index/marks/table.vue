<template>
    <div class="contariner-fluid">
        ...
        <div class="row" v-if="!showTable">
            <div class="col-6">
                <form> 
                    ...
                    <div class="button">
                        <button @click.prevent="showTableDetailsTheory" class="button__submit" type="submit">submit</button>
        ...
        <div class="row" v-if="showTable">
            <div class="col-6">
                 <div class="button">
                    <button @click.prevent="submitMarks" class="button__submit" type="submit">submit</button>
                </div>
            </div>
        </div>
        ...
        methods: {
            ...
            submitMarks(){
                this.blankMarksArray.forEach(mark => {
                    mark[2] = mark[2] >= 0 ? mark[2] : -9;
                    mark[3] = mark[3] >= 0 ? mark[3] : -9;
                    mark[4] = mark[4] >= 0 ? mark[4] : -9;
                    mark[5] = mark[5] >= 0 ? mark[5] : -9;
                    mark[6] = mark[6] || 'not';
                })               
